...
function setShopBlip()
	...
	ped = CreatePed(0, modelHash , -677.16296386719, 5832.423828125, 17.33 - 1,true)
	FreezeEntityPosition(ped, true)
	SetEntityInvincible(ped, true)
	SetEntityHeading(ped, 150.14245605469)
	SetBlockingOfNonTemporaryEvents(ped, true)
	TaskStartScenarioInPlace(ped, "WORLD_HUMAN_STAND_IMPATIENT_UPRIGHT", 0, true)
	...
	ped = CreatePed(0, modelHash , -1146.5438232422, 4940.9946289062, 222.26876831055 - 1,true)
	FreezeEntityPosition(ped, true)
	SetEntityInvincible(ped, true)
	SetEntityHeading(ped, 159.4330291748)
	SetBlockingOfNonTemporaryEvents(ped, true)
	...
	ped = CreatePed(0, modelHash , 22.148561477661, -1103.7393798828, 38.151630401611 - 1,true)
	FreezeEntityPosition(ped, true)
	SetEntityInvincible(ped, true)
	SetEntityHeading(ped, 344.21990966797)
	SetBlockingOfNonTemporaryEvents(ped, true)
	TaskStartScenarioInPlace(ped, "WORLD_HUMAN_AA_SMOKE", 0, true)
