...
function SellDrugs(NPC,saleprice, amount)
	...
	if sellingcrack or sellingcocaine or sellingweed or sellingmeth or sellingmethbad then
		...
		if sellingweed then
			TriggerServerEvent("sales:count","weedq",amount,MyStreetName)
		end	


		if sellingcocaine then
			TriggerServerEvent("sales:count","1gcocaine",amount)
		end	

		if sellingcrack then
			TriggerServerEvent("sales:count","1gcrack",amount)
		end	

		
		if sellingmeth then
			TriggerServerEvent("sales:count","1gmeth",amount)
		end	

		
		if sellingmethbad then
			TriggerServerEvent("sales:count","methbag",amount)
		end	
