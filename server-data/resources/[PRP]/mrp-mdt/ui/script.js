const mdtApp = new Vue({
    ...
    methods: {
        ...
        closeMDT() {
            $.post('http://mrp-mdt/close', JSON.stringify({}));
        },
        getClass(element) {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://mrp-mdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://mrp-mdt/viewOffender', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://mrp-mdt/performReportSearch', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://mrp-mdt/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://mrp-mdt/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://mrp-mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        //         $.post('http://mrp-mdt/vehicleSearch', JSON.stringify({
        ...
        //     $.post('http://mrp-mdt/getVehicle', JSON.stringify({
        //         vehicle: result
        //     }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://mrp-mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://mrp-mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://mrp-mdt/getReport', JSON.stringify({
                id: id
            }));
        ...
        //     $.post('http://mrp-mdt/saveVehicleChanges', JSON.stringify({
