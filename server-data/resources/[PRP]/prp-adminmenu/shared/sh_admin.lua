...
PRP._Admin.CurAdmins = {}

function PRP.Admin.Log(self, log, user)
...
function PRP.Admin.ChatPrint(self, msg, target)

end

function PRP.Admin.RankExists(self, rank)
    rank = tostring(rank)
...
function PRP.Admin.CommandExists(self, cmd)
    cmd = tostring(cmd)
...
function PRP.Admin.RankInheritsCommand(self, rank, cmd)
...
function PRP.Admin.RankHasCommand(self, rank, cmd)
...
function PRP.Admin.GetRanks(self)
    return PRP._Admin.Ranks
end

function PRP.Admin.GetRankData(self, rank)
    if not rank then return false end
...
function PRP.Admin.GetCommands(self)
    return PRP._Admin.Commands
end

function PRP.Admin.GetCategories(self)
    local tmp = {}
...
function PRP.Admin.GetCommandData(self, cmd)
    if not cmd then return false end
...
function PRP.Admin.IsAdmin(self, user)
    if not user then return false end
...
function PRP.Admin.IsSuperAdmin(self, user)
    if not IsDuplicityVersion() then
...
function PRP.Admin.IsValidUser(self, user)
    if not user then return false end
...
function PRP.Admin.CanTarget(self, user, target)
...
function PRP.Admin.CanTargetRank(self, user, rank)
...
function PRP.Admin.AddCommand(self, cmd)
    local tmp = {}
    ...
    if IsDuplicityVersion() then
        ...
        tmp.runcommand = function(args) args.command = tmp.command PRP.Admin:RunCommand(args) end
...
function PRP.Admin.AddRank(self, rank, data)
    local tmp = {}
...
function PRP.Admin.GetBanTimeFromString(self, time)
...
function PRP.Admin.SetStatus(self, status, src)
