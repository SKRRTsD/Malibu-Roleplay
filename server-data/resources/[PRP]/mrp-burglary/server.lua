local robbableItems = {
 ...
 -- [10] = {chance = 125, id = '-771403250', quantity = 1},
  ...
  [14] = {chance = 10, id = 'goldcoin', quantity = 1},
  ...
  [20] = {chance = 93, id = 'goldbar', math.random(0,1)},
  [21] = {chance = 97, id = 'anime', math.random(1,3)},
  [22] = {chance = 16, id = '453432689', 1},
  [23] = {chance = 95, id = 'joint', math.random(1,3)},
  [24] = {chance = 68, id = 'Boombox', 1},
  [25] = {chance = 76, id = 'advlockpick', 1},
  [26] = {chance = 70, id = '1gcrack', 1},
 }
