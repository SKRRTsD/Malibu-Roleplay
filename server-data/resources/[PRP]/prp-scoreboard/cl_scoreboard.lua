...
RegisterNetEvent("mrp-scoreboard:RemovePlayer")
AddEventHandler("mrp-scoreboard:RemovePlayer", function(data)
    PRP.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("mrp-scoreboard:AddPlayer")
AddEventHandler("mrp-scoreboard:AddPlayer", function(data)
    PRP.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("mrp-scoreboard:RemoveRecent")
AddEventHandler("mrp-scoreboard:RemoveRecent", function(src)
    PRP.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("mrp-scoreboard:AddAllPlayers")
AddEventHandler("mrp-scoreboard:AddAllPlayers", function(data)
