	...
	menu = {
		...
		["drift"] = {
			...
			buttons = {
				...
				{name = "Drift Tampa 2", costs = 110000, description = {}, model = "tampa2"},
		...
		["imports"] = {
			...
			name = "imports",
			buttons = {
				{model = "zr3806str", name = "ZR 3806 6STR", costs = 200000, description = {}},
				{model = "370z", name = "Nissan 370z", costs = 225000, description = {}},
				{model = "510", name = "Datus 510", costs = 150000, description = {}},
				{model = "911rwb", name = "Porsche 911 LWB", costs = 200000, description = {}},
				{model = "a80", name = "Toyota Supra A80", costs = 250000, description = {}},
				{model = "acs8", name = "BMW ACS8", costs = 210000, description = {}},
				{model = "ap2", name = "Honda AP2", costs = 180000, description = {}},
				{model = "e46", name = "BMW M3 E46", costs = 210000, description = {}},
				{model = "evo10", name = "Mitsubishi Lancer Evolution 10", costs = 200000, description = {}},
				{model = "lp700r", name = "Lamborghini LP700R", costs = 750000, description = {}},
				{model = "lwgtr", name = "Libertywalk GTR", costs = 500000, description = {}},
				{model = "lwgtr2", name = "Livertywalk GTR 2", costs = 500000, description = {}},
				{model = "rmodmustang", name = "Ford Mustang GT", costs = 350000, description = {}},
				{model = "rx7rb", name = "RX7 Rocketbunny", costs = 400000, description = {}},
				{model = "subwrx", name = "Subaru WRX", costs = 350000, description = {}},
				{model = "500gtrlam", name = "Lamborghini Diablo GTR", costs = 750000, description = {}},
				{model = "650slw", name = "McLaren 650S Liberty Walk", costs = 700000, description = {}},
				{model = "918", name = "Porsche 918 Spyder", costs = 800000, description = {}},
				{model = "audirs6tk", name = "Audi RS6", costs = 350000, description = {}},
				{model = "bdragon", name = "Bentley Dragon", costs = 500000, description = {}},
				{model = "c7", name = "Corvette C7", costs = 400000, description = {}},
				{model = "c63", name = "Mercedes AMG C63", costs = 400000, description = {}},
				{model = "contss18", name = "Bentlet Continental", costs = 600000, description = {}},
				{model = "cp9a", name = "Mitsubishi Lancer Evolution V RS (CP9A)", costs = 300000, description = {}},
				{model = "dc5", name = "Honda Type R DC5", costs = 450000, description = {}},
				{model = "e36prb", name = "BMW C3 E36", costs = 400000, description = {}},
				{model = "eclipse", name = "Mitsubishi Eclipse", costs = 350000, description = {}},
				{model = "esv", name = "Cadilac Escilade", costs = 300000, description = {}},
				{model = "exor", name = "Chevrolet Camaro", costs = 350000, description = {}},
				{model = "f150", name = "Ford Raptor F150", costs = 250000, description = {}},
				{model = "filthynsx", name = "Acura NSX", costs = 400000, description = {}},
				{model = "fk8", name = "Honda Civic Type R", costs = 250000, description = {}},
				{model = "fnfrx7", name = "FNF RX7", costs = 400000, description = {}},
				{model = "focusrs", name = "Ford Focus RS", costs = 350000, description = {}},
				{model = "golfp", name = "Volkswagen Golf", costs = 300000, description = {}},
				{model = "granlb", name = "Maserati GranTurismo", costs = 500000, description = {}},
				{model = "gt2rwb", name = "Porsche 911 GT2", costs = 350000, description = {}},
				{model = "gt63", name = "Mercedes AMG G63", costs = 500000, description = {}},
				{model = "gtr", name = "Nissan GTR", costs = 500000, description = {}},
				{model = "gtrc", name = "Mercedes AMG GTR", costs = 500000, description = {}},
				{model = "laferrari17", name = "Ferrari La Ferrari 17", costs = 750000, description = {}},
				{model = "lp670", name = "Lamborghini Murciélago LP670-4", costs = 750000, description = {}},
				{model = "m3e46", name = "BMW M3 E46", costs = 300000, description = {}},
				{model = "m4", name = "BMW M4", costs = 400000, description = {}},
				{model = "m5e60", name = "BMW M5 E60", costs = 300000, description = {}},
				{model = "MBW124", name = "Mercedes-Benz W124", costs = 350000, description = {}},
				{model = "mig", name = "Gemballa MIG-U1", costs = 750000, description = {}},
				{model = "mustang19", name = "Mustang 19", costs = 150000, description = {}},
				{model = "na1", name = "Honda NSX", costs = 650000, description = {}},
				{model = "na6", name = "MX5 NA6", costs = 400000, description = {}},
				{model = "p1", name = "McLaren P1", costs = 1000000, description = {}},
				...
				{model = "tempesta2", name = "6STR Lamborghini Hurrican", costs = 850000, description = {}},
				{model = "wraith", name = "Rolls-Royce Wraith", costs = 625000, description = {}},
				{model = "zondar", name = "Pagani Zonda", costs = 1000000, description = {}},
				{model = "2f2fgtr34", name = "GTR R34 (Livery)", costs = 500000, description = {}},
				{model = "fnf4r34", name = "GTR R34", costs = 500000, description = {}},
				{model = "comet6str", name = "Comet 6STR", costs = 400000, description = {}},
				{model = "ellie6str", name = "Vapid Ellie 6STR", costs = 350000, description = {}},
				{model = "gauntlet6str", name = "Gauntlet 6STR", costs = 350000, description = {}},
				{model = "hellion6str", name = "Hellion 6STR", costs = 400000, description = {}},
				{model = "ladybird6str", name = "Ladybird 6STR", costs = 500000, description = {}},
				{model = "revolution6str", name = "Revolution 6STR", costs = 500000, description = {}},
			}
		},
	}
}
...
local carTable = {
	[1] = { ["model"] = "gtr", ["baseprice"] = 255000, ["commission"] = 15 }, 
	[2] = { ["model"] = "tempesta2", ["baseprice"] = 175000, ["commission"] = 15 },
	[3] = { ["model"] = "por930", ["baseprice"] = 190000, ["commission"] = 15 },
	[4] = { ["model"] = "ar8lb", ["baseprice"] = 160000, ["commission"] = 15 },
	[5] = { ["model"] = "er34", ["baseprice"] = 215000, ["commission"] = 15 },
	[6] = { ["model"] = "xa21", ["baseprice"] = 200000, ["commission"] = 15 },
	[7] = { ["model"] = "c7", ["baseprice"] = 170000, ["commission"] = 15 },
	[8] = { ["model"] = "wraith", ["baseprice"] = 220000, ["commission"] = 15 },
}
