...
function PRP.Admin.CheckForSessions(self)
    ...
    --         local players = PRP._Admin.Players

    --         for k,v in pairs(players) do
    --             local src = v.source
    --             local playerId = GetPlayerFromServerId(src)
    --             if not src then
    --                 PRP._Admin.Players[src].sessioned = true
    --             else
    --                 if not NetworkIsPlayerActive(playerId) or not NetworkIsPlayerConnected(playerId) then PRP._Admin.Players[src].sessioned = true end
    --             end
    --         end
    --     end
    -- end)
...
function PRP.Admin.teleportMarker(self)
...
function PRP.Admin.split(source, sep)
    local result, i = {}, 1
    while true do
...
function PRP.Admin.RunNclp(self,bool)
    local cmd = {}
    cmd = {
        vars = {}
    }
