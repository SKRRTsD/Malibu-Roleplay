...
local carspawns = {
	[1] =  { ['x'] = -1470.8937988281,['y'] = -925.16326904297,['z'] = 9.4840078353882,['h'] = 320.51510620117, ['info'] = ' car 8' },
	[2] =  { ['x'] = -1468.6512451172,['y'] = -927.08099365234,['z'] = 9.4867868423462,['h'] = 321.69509887695, ['info'] = ' car 1' },
	[3] =  { ['x'] = -1465.2770996094,['y'] = -929.20318603516,['z'] = 9.4752712249756,['h'] = 300.880859375, ['info'] = ' car 2' },
}
...
AddEventHandler("oxydelivery:client", function()
	...
	while tasking do
		...
		if dstcheck < 40.0 and not pedCreated and (oxyVehicle == veh or dstcheck2 < 15.0) then
			...
			DeleteCreatedPed()
			CreateOxyPed()
			TriggerEvent("DoLongHudText","You are close to the customer")
		end
		toolong = toolong - 1
		if toolong < 0 then
...
function CreateOxyVehicle()
    ...
    while true do
    	Citizen.Wait(1)
    	 DrawText3Ds(carspawns[spawnpoint]["x"], carspawns[spawnpoint]["y"], carspawns[spawnpoint]["z"], "Your Delivery Car")
...
function DoDropOff(requestMoney)
	...
	if success then
		Citizen.Wait(2000)
		TriggerEvent("DoLongHudText", "delivery was on point, go wait the next one",1)
	else
