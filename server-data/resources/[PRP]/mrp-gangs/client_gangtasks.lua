...
-- 	local crack = exports["mrp-inventory"]:hasEnoughOfItem("1gcrack",5,false)
-- 	if crack and sellingcrack then
-- 		TriggerEvent("inventory:removeItem", "1gcrack", 5)
-- 	end

-- 	local meth = exports["mrp-inventory"]:hasEnoughOfItem("1gmeth",5,false)
-- 	if meth and sellingmeth then
-- 		TriggerEvent("inventory:removeItem", "1gmeth", 5)
-- 	end

-- 	local methbad = exports["mrp-inventory"]:hasEnoughOfItem("methbag",5,false)
-- 	if methbad and sellingmethbad then
-- 		TriggerEvent("inventory:removeItem", "methbag", 5)
-- 	end

-- 	local weedbaggies = exports["mrp-inventory"]:hasEnoughOfItem("weedq",5,false)
-- 	if weedbaggies and sellingweed then
-- 		TriggerEvent("inventory:removeItem", "weedq", 5)
-- 	end


-- 	local cocaine = exports["mrp-inventory"]:hasEnoughOfItem("1gcocaine",5,false) 
